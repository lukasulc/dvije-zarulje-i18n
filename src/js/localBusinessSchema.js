	...
	const schema = {
		...
		"@graph": [
			...
			},
			{
				...
				"@id": businessId,
				name: BUSINESS.name,
				alternateName: ["Dvije Zarulje", "2 Zarulje"],
				description: SITE.description,
				url: SITE.url,
				...
				keywords: "Dvije Zarulje, Dvije Žarulje, grill Zagreb, rostilj Zagreb, cevapi Zagreb, daily menu Zagreb, dnevna jela Zagreb, Bundek, Sredisce, Ulica Brune Busica 28",
				sameAs,
			...
			},
			{
				...
				description: "Bundek is a Novi Zagreb lake and park area near Dvije Zarulje, with walking paths, green areas and children's playgrounds.",
				containedInPlace: {
					"@type": "City",
					name: "Zagreb",
				},
